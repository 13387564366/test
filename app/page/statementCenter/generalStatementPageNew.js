...
const columnCount = 8; // 暂时、全屏幕最多 8 列展示
    ...
    _fetchData() {
        ...
        InteractionManager.runAfterInteractions(() => {
            StatementAction.fetchGeneralStatementDataWithCondition({
                id: this.props.param.reportInfo.id,
                dataType: 'report',
                selectType: 'filter',
    ...
    render() {
        return (
            <NavigationBar
                ...
                title={this.props.param.reportInfo.name}
                goBack={true}
