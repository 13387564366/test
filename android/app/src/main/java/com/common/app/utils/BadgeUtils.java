...
public class BadgeUtils {
    private static final String LOG_TAG = "BADGE_UTILS";
...
//        notificationManager.notify(notificationId++, notification);
    ...
    private static boolean setHuaweiBadge(int count, Context context) {
        try {
            ...
            String contentUriStr = "content://com.huawei.android.launcher.settings/badge/";
            Bundle bundle = new Bundle();
            bundle.putString("package", context.getPackageName());
            bundle.putString("class", launchClassName);
            bundle.putInt("badgenumber", count);
            context.getContentResolver().call(Uri.parse(contentUriStr), "change_badge", null, bundle);
            return true;
        } catch (Exception e) {
            e.printStackTrace();
            return false;
